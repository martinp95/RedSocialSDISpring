...
public class RedSocialSDITests {
	...
	PO_LoginView.fillForm(driver, "email1@example.com", "123456");
    ...
    public void InInVal() {
	PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	PO_LoginView.fillForm(driver, "noExiste@example.com", "123456");
	...
	PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	PO_LoginView.fillForm(driver, "email2@example.com", "123456");
	...
	email.click();
	email.clear();
	email.sendKeys("email11@example.com");
	...
	email.click();
	email.clear();
	email.sendKeys("email1@example.com");
	WebElement password = driver.findElement(By.name("password"));
	password.click();
	password.clear();
	password.sendKeys("123456");
	...
	SeleniumUtils.textoNoPresentePagina(driver, "email5@example.com");
    }
